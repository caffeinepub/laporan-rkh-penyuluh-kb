import { c as createLucideIcon, j as jsxRuntimeExports, d as cn, l as useCreateRKHReport, m as useUpdateReport, n as useInternetIdentity, r as reactExports, L as Label, I as Input, B as Button, g as LoaderCircle, h as ue, o as loadConfig, p as HttpAgent, S as StorageClient } from "./index-B_nksXmQ.js";
import { U as Upload } from "./upload-DDS7CzGA.js";
import { F as FileText } from "./file-text-6WISAzmV.js";
...
function InputRKHPage({
  ...
  const [compressedSizes, setCompressedSizes] = reactExports.useState([]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "p-6 space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400 mb-2", children: [
          "Unggah minimal ",
          MIN_ATTACHMENTS,
          " file pendukung: gambar, PDF, Word, atau format lainnya. Gambar akan dikecilkan otomatis."
        ] }),
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
                  ...
                  file.type.startsWith("image/") && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-green-500", children: "(dikompres)" })
                ] }),
        ...
        attachedFiles.length > 0 && attachedFiles.length < MIN_ATTACHMENTS && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          [1, 2].map((step) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
