import { c as createLucideIcon, r as reactExports, n as reactDomExports, j as jsxRuntimeExports, P as Primitive, u as useComposedRefs, a as createSlot, d as cn, o as useQueryRKHReports, B as Button, g as LoaderCircle, p as Paperclip } from "./index-Cc_EEX_q.js";
import { e as useLayoutEffect2, c as createContextScope, h as useCallbackRef, u as useControllableState, b as useId, d as composeEventHandlers, g as getCurrentMonthYear, B as BULAN_ID, i as formatMonthYear, f as formatTanggal } from "./date-DiHLEccA.js";
import { u as useDirection, c as createCollection } from "./index-DhM1UlfS.js";
import { P as Portal$1, h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer } from "./index-UuMc0O2M.js";
/**
...
function parseLampiran(lampiran) {
  if (!lampiran) return [];
  try {
...
function PrintSingleReport({
  ...
  const identitasRows = [
    ["Nama", (profile == null ? void 0 : profile.nama) ?? "-"],
    ["NIP", (profile == null ? void 0 : profile.nip) ?? "-"],
    ["Unit Kerja", (profile == null ? void 0 : profile.unitKerja) ?? "-"],
    ["Wilayah", (profile == null ? void 0 : profile.wilayahKerja) ?? "-"]
  ];
  const headerStyle = {
    background: "#1a5c3e",
    color: "#fff",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, textAlign: "center" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: "LAPORAN RENCANA KERJA HARIAN PENYULUH KB"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "9pt", marginTop: "3px", color: "#333" }, children: "Badan Kependudukan dan Keluarga Berencana Nasional" }),
                  (profile == null ? void 0 : profile.unitKerja) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "9pt", color: "#555" }, children: profile.unitKerja })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "14px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "IDENTITAS PENYULUH" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("table", { style: tableStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: identitasRows.map(([label, val]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: "1px solid #ddd" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: cellLabelStyle, children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: cellValueStyle, children: val })
            ] }, label)) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "14px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "DETAIL LAPORAN" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("table", { style: tableStyle, children: /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: detailRows.map(([label, val]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { style: { borderBottom: "1px solid #ddd" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: cellLabelStyle, children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: cellValueStyle, children: val })
            ] }, label)) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "24px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: headerStyle, children: "LAMPIRAN" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                style: {
                ...
                children: allLampiranLabels.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: 0, color: "#888" }, children: "Tidak ada lampiran." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: "0 0 6px" }, children: [
                    "Ada ",
                    allLampiranLabels.length,
                    " file lampiran yang terlampir pada halaman lampiran(nya)."
                  ] }),
                  allLampiranLabels.map((label, i) => (
                    // biome-ignore lint/suspicious/noArrayIndexKey: static list, order does not change
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { margin: "2px 0" }, children: [
                      "Lampiran ",
                      i + 1,
                      ": ",
                      label
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
                textAlign: "center",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: "0 0 2px" }, children: "Yang Membuat Laporan," }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: (profile == null ? void 0 : profile.tandaTangan) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "img",
                      {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: (profile == null ? void 0 : profile.nama) ?? "_____________________"
                  }
                ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: footerStyle, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              ...
              (profile == null ? void 0 : profile.unitKerja) ?? "BKKBN"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Halaman 1" })
          ] })
        ]
      }
    ),
    gambarItems.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: "9pt", color: "#555", marginBottom: "12px" }, children: [
            "Laporan tanggal ",
    ...
    dokumenItems.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: { ...pageStyle, pageBreakBefore: "always" },
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#666", fontSize: "9pt" }, children: "File dokumen ini tersedia secara digital." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    style: {
...
function RiwayatLaporanPage({
  profile,
  isAdmin = false,
  onNavigate
}) {
  const { bulan: initBulan, tahun: initTahun } = getCurrentMonthYear();
  const [bulan, setBulan] = reactExports.useState(initBulan);
  const [tahun, setTahun] = reactExports.useState(initTahun);
  const [printReport, setPrintReport] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-print space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg shadow-card p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-bold text-brand-nav", children: "Riwayat Laporan RKH" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mt-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: bulan, onValueChange: setBulan, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
                  id: "filter-bulan",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: BULAN_ID.map((nama) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectItem,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: tahun, onValueChange: setTahun, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
                  id: "filter-tahun",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg shadow-card overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-3 border-b border-brand-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-brand-nav", children: [
            "Laporan Bulan ",
            bulanName
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-brand-muted", children: [
            sorted.length,
            " laporan ditemukan"
          ] })
        ] }),
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-brand-muted", children: "Tidak ada laporan untuk periode ini" })
          }
          ...
          "table",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-50 text-xs font-semibold text-brand-muted uppercase", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left hidden sm:table-cell", children: "Sasaran" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center hidden sm:table-cell", children: "Jml" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left hidden md:table-cell", children: "Lokasi" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left hidden lg:table-cell", children: "Hasil Kegiatan" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center hidden sm:table-cell", children: "Lampiran" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center", children: "Aksi" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-brand-border", children: sorted.map((r, idx) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "tr",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center hidden sm:table-cell text-xs", children: r.jumlahSasaran.toString() }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden md:table-cell text-xs text-brand-muted", children: r.lokasi }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-clamp-2 text-xs text-brand-muted", children: r.hasilKegiatan }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-center hidden sm:table-cell", children: lampiranItems.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs text-green-700", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 justify-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: printRef, className: "print-only", children: printRows.map((report, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PrintSingleReport,
      {
        report,
        profile,
