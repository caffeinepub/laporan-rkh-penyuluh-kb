import { c as createLucideIcon, D as useInternetIdentity, r as reactExports, o as useQueryRKHReports, j as jsxRuntimeExports, p as Paperclip, g as LoaderCircle, B as Button, h as ue, E as createActorWithConfig, F as getSecretParameter, G as loadConfig, J as HttpAgent, S as StorageClient } from "./index-Bk301muy.js";
...
function UploadLampiranPage({
  ...
  const handleMerge = async (report) => {
    ...
    const currentIdentity = identityRef.current;
    if (!currentIdentity) {
      ue.error("Sesi login tidak ditemukan. Silakan login ulang.");
      return;
    }
