...
export function InternetIdentityProvider({
  ...
  // Initialize only once - use ref to store createOptions to avoid re-runs
  // biome-ignore lint/correctness/useExhaustiveDependencies: intentional single initialization
  useEffect(() => {
